...
def plot_timeseries_rsa(args,
    ...
    heights = np.array([comparisons[t][comparison_layer].get_means()[ds+2] for ds in range(len(comparison_ds)) for t in range(timesteps)])
...
if __name__ == '__main__':
    ...
    parser.add_argument("-f", "--filename", type=str, required=True, help="Path to file with RSA results", action='append')
